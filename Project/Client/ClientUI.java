...
public class ClientUI extends JFrame implements IClientEvents, ICardControls {
    CardLayout cardView = null;// accessible so we can call next() and previous()
    ...
    @Override
    public void next() {
        cardView.next(container);
        findAndSetCurrentPanel();
    }

    @Override
    public void previous() {
        cardView.previous(container);
        
    }

    @Override
    public void show(String cardName) {
        cardView.show(container, cardName);
        findAndSetCurrentPanel();
    }
